...
// //     useEffect(() => {
// //     fetch("https://thingproxy.freeboard.io/fetch/https://www.swiggy.com/mapi/menu/pl?page-type=REGULAR_MENU&complete-menu=true&lat=12.9628669&lng=77.57750899999999&restaurantId=364221")
// //         .then((res) => res.json())
// //         .then((data) => {
// //             console.log(JSON.stringify(data)); // Copy this output
// //         });
// // }, []);
